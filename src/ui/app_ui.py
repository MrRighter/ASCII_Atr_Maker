...
def main(page: ft.Page):
    ...
    alphabet_dict = {
        ...
        "Круглый": [
            "Подойдёт любое фото с любым фильтром. Рекомендуется использовать шрифт NotoSansJP и выключать тумблер свободного пространства",
            "●",
        ],
        "Пиксельный": [
            "Подойдёт любое фото с любым фильтром. Рекомендуется использовать шрифт GothicA1 и выключать тумблер свободного пространства",
            "█",
        ],
    }
